...
namespace Lime_Editor.Migrations
{
    ...
    [Migration("20260706175614_DropDeadLegacyTemplatePreviews")]
    partial class DropDeadLegacyTemplatePreviews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lime_Editor.Models.GitHubConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Lime_Editor.Models.GitHubSiteDeployment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("VercelProjectId")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");

                    b.Property<string>("VercelUrl")
                        .HasMaxLength(400)
                        .HasColumnType("character varying(400)");
                    ...
                    b.HasIndex("SiteId", "Mode")
                        .IsUnique();

                    b.ToTable("GitHubSiteDeployments");
                });
            ...
            modelBuilder.Entity("Lime_Editor.Models.Plan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AllowExport = true,
                            Currency = "RUB",
                            Description = "Для фрилансеров: экспорт кода, свой CSS и больше AI.",
                            FeaturesJson = "{}",
                            MaxCustomDomains = 3,
                            MaxSites = 25,
                            MaxStorageMb = 5120,
